...
app.post('/register', (req, res) => {
    ...
    db.all(checkUserQuery, [], (err, rows) => {
        ...
        bcrypt.hash(password, 10, (err, hash) => {
            ...
            const insertQuery = `INSERT INTO users (username, email, password, profile_data) VALUES ('${username}', '${email}', '${hash}', '${profileData || '{}'}')`;
...
app.post('/login', (req, res) => {
    ...
    const query = `SELECT * FROM users WHERE username = '${sanitizeInput(username)}' OR email = '${sanitizeInput(username)}'`;
...
app.listen(PORT, () => {
    ...
    console.log('This app contains intentional vulnerabilities for testing purposes!');
});
